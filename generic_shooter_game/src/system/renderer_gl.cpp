...
uint64_t gsg::SystemGLRenderer::required_components() const {
	return sol::ENTITY | sol::TRANSFORM | sol::MODEL;
}

void gsg::SystemGLRenderer::on_scene_loaded(std::unique_ptr<sol::ISceneDirectAccess>) {
...
void gsg::SystemGLRenderer::on_scene_update(std::unique_ptr<sol::ISceneDirectAccess>) {
	gl::Clear(gl::COLOR_BUFFER_BIT | gl::DEPTH_BUFFER_BIT);

	// alot of stuff
}

void gsg::SystemGLRenderer::on_scene_save(std::unique_ptr<sol::ISceneDirectAccess>, void* replace_with_save_file) {

}

void gsg::SystemGLRenderer::on_scene_shutdown(std::unique_ptr<sol::ISceneDirectAccess>) {
